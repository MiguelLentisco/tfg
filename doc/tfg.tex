...
% Autor de la memoria: Miguel Lentisco Ballesteros
...
\setpartpreamble[c][0.75\linewidth]{
  ...
  En \autoref{ch:pv-introduccion} se introduce el contexto bajo el que surge el $PV$ y que se va a intentar obtener, definiéndolo formalmente y describiendo su implementación en \autoref{ch:pv-seleccion}. Finalmente, realizamos los experimentos para comprobar su utilidad, junto con los resultados y análisis de estos en \autoref{ch:pv-experimentacion}.
}
\part{Selección de modelos para clasificación de series temporales}\label{part:pv}
...
\cleardoublepage\part{Detección de anomalías en series temporales}\label{part:ad}
