...
Constructor de la clase PV que necesita los datos originales, el número de perturbaciones, el nombre del dataset, y el inicio y fin de los ratio de error. Crea los conjuntos de etiquetas perturbadas.
